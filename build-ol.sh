...
# Stack name
#
STACK_NAME="${STACK_NAME:-Open Liberty}"
 
#
# Stack short name
#
STACK_SHORT_NAME="${STACK_SHORT_NAME:-openliberty}"
...
#
LIBERTY_IMAGE="${LIBERTY_UBI_IMAGE:-openliberty/open-liberty:21.0.0.9-full-java11-openj9-ubi}"
...
#
STACK_IMAGE_MAVEN="${STACK_IMAGE_MAVEN:-openliberty/application-stack:0.8}"
STACK_IMAGE_GRADLE="${STACK_IMAGE_GRADLE:-openliberty/application-stack:gradle-0.3}"
